function TestHighlightStyles()
  ...
  vim.api.nvim_set_hl(0, "UnderlineDefault", { underline = true, fg = "#ffffff" })
  vim.api.nvim_set_hl(0, "UnderlineColor", { underline = true, sp = "#00ffff", fg = "#ffffff" })
  vim.api.nvim_set_hl(0, "UndercurlColor", { undercurl = true, sp = "#ff00ff", fg = "#ffffff" })
